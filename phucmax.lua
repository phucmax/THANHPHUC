...
local TELE_TARGET = Vector3.new(520.82, 70.57, -362.08)
...
local oldGui = playerGui:FindFirstChild("PHUCMAX_EGG_TOOLS")
if oldGui then
    oldGui:Destroy()
end
...
local function teleport100()
    ...
    root.CFrame = CFrame.new(TELE_TARGET)
...
task.spawn(function()
    while not destroyed do
        ...
        task.wait(0.)
    end
end)
...
LocalPlayer.CharacterAdded:Connect(function(char)
    ...
    task.wait(0.)
