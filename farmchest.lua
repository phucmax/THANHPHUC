...
local THEME_COLOR = Color3.fromRGB(0,0,205)
...
pcall(function()
    ...
    Info.TextColor3 = Color3.fromRGB(127, 219, 255)
    ...
    HopBtn.MouseButton1Click:Connect(function()
        ...
        pcall(function()
            ...
            if type(HopServer) == "function" then pcall(HopServer) end
...
function ForceStopChestCollection()
    ...
    pcall(function()
        ...
        StarterGui:SetCore("SendNotification", { Title = "PHUCMAX", Text = "Chest collection forced stop", Duration = 3 })
